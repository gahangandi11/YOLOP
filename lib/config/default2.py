...
_C.PIN_MEMORY = False
_C.PRINT_FREQ = 20
_C.AUTO_RESUME = True    # Resume from the last training interrupt ########CHANGE THIS!!!!!
...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = ""
_C.MODEL.PRETRAINED_DET = "" ###I added pretrained weights for the dete
...
_C.TRAIN.LRF =  0.2  # final OneCycleLR learning rate (lr0 * lrf) #### yolov8 0.01
...
_C.TRAIN.END_EPOCH = 300 #240 ############

_C.TRAIN.VAL_FREQ = 1
_C.TRAIN.BATCH_SIZE_PER_GPU = 9  ##10 #24 ##############
_C.TRAIN.SHUFFLE = True

_C.TRAIN.IOU_THRESHOLD = 0.3 ###0.001
...
_C.TEST.PLOTS = True
_C.TEST.NMS_CONF_THRESHOLD  =0.3 #0.001 ###0.3 ####0.001
