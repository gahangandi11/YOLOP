...
_C.PIN_MEMORY = True
_C.PRINT_FREQ = 2150
_C.AUTO_RESUME = False    # Resume from the last training interrupt ########CHANGE THIS!!!!!
...
_C.DATASET.DATAROOT = '/home/jakisa/Documents/YOLOP_tweak/mini_datasets/imgs'       # the path of images folder
_C.DATASET.LABELROOT = '/home/jakisa/Documents/YOLOP_tweak/mini_datasets/det_annot'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/jakisa/Documents/YOLOP_tweak/mini_datasets/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/jakisa/Documents/YOLOP_tweak/mini_datasets/ll_seg_annotations'
...
_C.TRAIN.LR0 =  0.001  # initial learning rate (SGD=1E-2, Adam=1E-3) ##### yolov8 0.01
_C.TRAIN.LRF =  0.1  # final OneCycleLR learning rate (lr0 * lrf) #### yolov8 0.01
_C.TRAIN.WARMUP_EPOCHS = 3.0
_C.TRAIN.WARMUP_BIASE_LR = 0.1
_C.TRAIN.WARMUP_MOMENTUM =  0.8

_C.TRAIN.OPTIMIZER = 'adam' ###################'adam' 
...
_C.TRAIN.END_EPOCH =  100 #300 #240 ############

_C.TRAIN.VAL_FREQ = 20
_C.TRAIN.BATCH_SIZE_PER_GPU = 16 #28 #32  ##10 #24 ##############
_C.TRAIN.SHUFFLE = True

_C.TRAIN.IOU_THRESHOLD = 0.2 ###0.001
...
_C.TEST.BATCH_SIZE_PER_GPU = 16 #28 #32
_C.TEST.MODEL_FILE = ''
_C.TEST.SAVE_JSON = False
_C.TEST.SAVE_TXT = False
_C.TEST.PLOTS = True
_C.TEST.NMS_CONF_THRESHOLD  = 0.001 #0.001 ###0.3 ####0.001
